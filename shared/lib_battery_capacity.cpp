...
void capacity_interface::compute_charge_modes(capacity_state& state)
{
...
void capacity_interface::apply_SOC_limits(capacity_state &state, const battery_capacity_params &params)
{
