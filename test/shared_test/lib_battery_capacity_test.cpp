...
TEST_F(LiIon_lib_battery_capacity_test, updateCapacityTest){
    ...
    auto s1 = capacity_state({498.5, 1000, 1000, 1.5, 0,
                             49.85, 50.15, 0, 2});
    compareState(model->get_state(), s1, "updateCapacityTest: 1");
    ...
    s1 = {495.5, 1000, 1000, 3, 0,
          49.55, 50.45, 50.15, 2};
    compareState(model->get_state(), s1, "updateCapacityTest: 2");

    I = 490;
    model->updateCapacity(I);
    s1 = {150, 1000, 1000, 345.5, 0,
          15, 85, 50.45, 2};
    compareState(model->get_state(), s1, "updateCapacityTest: 3");

    I = 490;
    model->updateCapacity(I);
    s1 = {150, 1000, 1000, 0, 0,
          15, 85, 85, 1};
    compareState(model->get_state(), s1, "updateCapacityTest: 4");
}
...
TEST_F(LiIon_lib_battery_capacity_test, updateCapacityThermalTest){
    ...
    auto s1 = capacity_state({500, 1000, 800, 0, 0,
                              62.5, 37.5, 0, 2});
    compareState(model->get_state(), s1, "updateCapacityThermalTest: 1");

    percent = 50;
    model->updateCapacityForThermal(percent);
    s1 = {500, 1000, 500, 0, 0, 100, 0, 37.5, 2};
    compareState(model->get_state(), s1, "updateCapacityThermalTest: 2");

    percent = 10;
    model->updateCapacityForThermal(percent);
    s1 = {100, 1000, 100, 0, 400, 100, 0, 0, 2};
    compareState(model->get_state(), s1, "updateCapacityThermalTest: 3");

    percent = 110;
    model->updateCapacityForThermal(percent);
    s1 = {100, 1000, 1100, 0, 400, 10, 90, 0, 2};
    compareState(model->get_state(), s1, "updateCapacityThermalTest: 4");
...
TEST_F(LiIon_lib_battery_capacity_test, updateCapacityLifetimeTest){
    ...
    compareState(model->get_state(), s1, "updateCapacityLifetimeTest: 1");

    percent = 50;
    model->updateCapacityForLifetime(percent);
    s1 = {500, 500, 1000, 0, 0, 100, 0, 37.5, 2};
    compareState(model->get_state(), s1, "updateCapacityLifetimeTest: 2");

    percent = 10;
    model->updateCapacityForLifetime(percent);
    s1 = {100, 100, 1000, 0, 400, 100, 0, 0, 2};
    compareState(model->get_state(), s1, "updateCapacityLifetimeTest: 3");

    percent = 110;
    model->updateCapacityForLifetime(percent);
    s1 = {100, 100, 1000, 0, 400, 100, 0, 0, 2};
    compareState(model->get_state(), s1, "updateCapacityLifetimeTest: 4");

    percent = -110;
    model->updateCapacityForLifetime(percent);
    s1 = {0, 0, 1000, 0, 500, 0, 100, 0, 2};
    compareState(model->get_state(), s1, "updateCapacityLifetimeTest: 5");
}

TEST_F(LiIon_lib_battery_capacity_test, replaceBatteryTest){
    auto s1 = capacity_state{500, 1000, 1000, 0, 0, 50, 50, 0, 2};
    compareState(model->get_state(), s1, "replaceBatteryTest: init");

    // degrade 100% of battery
    model->updateCapacityForLifetime(0);
    s1 = {0, 0, 1000, 0, 500,0, 100, 0, 2};
    compareState(model->get_state(), s1, "replaceBatteryTest: init degradation");

    double percent = 50;
    model->replace_battery(percent);
    s1 = {250, 500, 500, 0, 500,50, 50, 0, 2};
    compareState(model->get_state(), s1, "replaceBatteryTest: 1");

    percent = 20;
    model->replace_battery(percent);
    s1 = {350, 700, 700, 0, 500, 50, 50, 0, 2};
    compareState(model->get_state(), s1, "replaceBatteryTest: 2");

    percent = 110;
    model->replace_battery(percent);
    s1 = {500, 1000, 1000, 0, 500, 50, 50, 0, 2};
    compareState(model->get_state(), s1, "replaceBatteryTest: 4");

    percent = -110;
    model->replace_battery(percent);
    s1 = {500, 1000, 1000, 0, 500, 50, 50, 0, 2};
    compareState(model->get_state(), s1, "replaceBatteryTest: 5");
}
...
TEST_F(LiIon_lib_battery_capacity_test, runSequenceTest) {
    ...
    auto s1 = capacity_state({150, 1000, 1000, 350, 0,
                              15, 85, 0, 2});
    compareState(model->get_state(), s1, "runSequenceTest: 1");
    I = -400;
    model->updateCapacity(I);
    s1 = capacity_state({550, 1000, 1000, -400, 0,
                              55, 45, 85, 0});
    compareState(model->get_state(), s1, "runSequenceTest: 2");

    double percent = 80;
    model->updateCapacityForThermal(percent);
    s1 = capacity_state({550, 1000, 800, -400, 0,
                         68.75, 31.25, 45, 0});
    compareState(model->get_state(), s1, "runSequenceTest: 3");

    I = 400;
    model->updateCapacity(I);
    s1 = capacity_state({150, 1000, 800, 400, 0,
                         18.75, 81.25, 31.25, 2});
    compareState(model->get_state(), s1, "runSequenceTest: 4");

    I = -400;
    model->updateCapacity(I);
    s1 = capacity_state({550, 1000, 800, -400, 0,
                         68.75, 31.25, 81.25, 0});
    compareState(model->get_state(), s1, "runSequenceTest: 5");

    percent = 70;
    model->updateCapacityForLifetime(percent);
    s1 = capacity_state({550, 700, 800, -400, 0,
                         78.57, 21.428, 31.25, 0});
    compareState(model->get_state(), s1, "runSequenceTest: 6");

    percent = 20;
    model->replace_battery(percent);
    s1 = {650, 900, 900, -400, 0, 72.22, 27.77, 21.4, 0};
    compareState(model->get_state(), s1, "runSequenceTest: 7");

    I = 400;
    model->updateCapacity(I);
    s1 = capacity_state({250, 900, 900, 400, 0,
                         27.77, 72.22, 27.77, 2});
    compareState(model->get_state(), s1, "runSequenceTest: 8");
}
