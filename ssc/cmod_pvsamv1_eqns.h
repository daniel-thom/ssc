...
static const char *Reopt_size_battery_params_doc =
        ...
        "     'subarray1_track_mode' - conditional double, 0=fixed,1=1axis,2=2axis,3=azi,4=monthly\\n"
        "     'subarray1_backtrack' - conditional double, 0=false, 1=true\\n"
        ...
        "     'degradation' - double [%/year], Annual PV energy production degradation, 0-100\\n"
